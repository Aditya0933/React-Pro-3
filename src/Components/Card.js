...
const Card =(props)=>{
    ...
    return(
        <div className="w-[300px] bg-blue bg-opacity-80 rounded-md overflow-hidden">
            <div className="relative">
                <img src = {course.image.url}/>
                <div className="w-[45px] h-[45px] bg-white rounded-full absolute right-2 bottom-3 grid place-items-center">
